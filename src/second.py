...
st.title("Rwanda Unemployment Analysis Dashboard")
st.markdown("""
    ### Understanding the Unemployment Challenge in Rwanda
    This dashboard provides insights into youth unemployment, the impact of education on employment, and the status of employment across urban and rural areas. 
    Here, we explore if unemployment rates might sometimes exceed employment rates in specific demographics, highlighting critical areas for policy intervention.
""")

# Section 1: Youth Unemployment Analysis
st.header("Youth Unemployment Indicators")
st.markdown("#### Youth unemployment rates among those aged 15-24 in Rwanda")

# Filter and structure the youth data
df_youth_chart = df_youth.iloc[0:5, [22]]
...
df_youth_chart['Q2'] = df_youth_chart['Q2'] * 100
